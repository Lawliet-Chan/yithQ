...
func (n *Node) Consume(topic string, partitionID int, popOffset int64, amount int, writer http.ResponseWriter) error {
	...
	return partition.(*Partition).Consume(popOffset, amount, writer)
}
